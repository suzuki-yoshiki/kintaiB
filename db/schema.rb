...
ActiveRecord::Schema.define(version: 20200517150413) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.string "mark_apploval_confirmation"
    t.string "mark_change_confirmation"
    t.string "apploval_confirmation"
    t.string "change_confirmation"
    t.string "mark_finish"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "basic_work_time", default: "2020-05-17 23:00:00"
